...
import { log, TreebeardCore } from './index.js';
...
describe('Exported Log Functions', () => {
  ...
  describe('SDK Lifecycle Integration', () => {
    it('should work correctly after SDK restart', async () => {
      // Initialize SDK
      core = TreebeardCore.init({ batchSize: 1, apiKey: 'test-key' });
      ...
      // Reinitialize SDK
      core = TreebeardCore.init({ batchSize: 1, apiKey: 'test-key-2' });
    ...
    it('should handle multiple initializations correctly', () => {
      const core1 = TreebeardCore.init({ batchSize: 1, apiKey: 'test-key-1' });
      const core2 = TreebeardCore.init({ batchSize: 1, apiKey: 'test-key-2' });
